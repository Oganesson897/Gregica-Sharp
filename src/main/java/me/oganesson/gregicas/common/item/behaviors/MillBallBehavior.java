package me.oganesson.gregicas.common.item.behaviors;
...
public class MillBallBehavior extends AbstractMaterialPartBehavior implements IItemMaxStackSizeProvider {
    ...
    public int getPartMaxDurability(ItemStack itemStack) {
        if(GSMetaItems.GRINDBALL_SOAPSTONE.isItemEqual(itemStack))
            return 50;
        else
            return 100;
    }
    ...
    public void addInformation(ItemStack stack, List<String> lines) {
        Material material;
        if(GSMetaItems.GRINDBALL_SOAPSTONE.isItemEqual(stack))
