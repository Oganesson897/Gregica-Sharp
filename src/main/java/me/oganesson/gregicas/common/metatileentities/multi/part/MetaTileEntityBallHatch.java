package me.oganesson.gregicas.common.metatileentities.multi.part;
...
public class MetaTileEntityBallHatch extends MetaTileEntityMultiblockPart implements IMultiblockAbilityPart<IBall>, IBall {

    private final InventoryBallHolder inventory;

    public MetaTileEntityBallHatch(ResourceLocation metaTileEntityId) {
    ...
    private class InventoryBallHolder extends ItemStackHandler {
        ...
        private int getBallTier(){
            if(getBallStack() == null)
                ...
                return GSMetaItems.GRINDBALL_SOAPSTONE.isItemEqual(getBallStack()) ? 1 : 2;
        }
    ...
    public void update() {
        ...
        MetaTileEntityIsaMill controller = (MetaTileEntityIsaMill) getController();
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new MetaTileEntityBallHatch(this.metaTileEntityId);
    }
...
//    }
    ...
    public void renderMetaTileEntity(CCRenderState renderState, Matrix4 translation, IVertexOperation[] pipeline) {
        ...
        if (this.shouldRenderOverlay()){
            GSTextures.BALL_HATCH.renderSided(getFrontFacing(), renderState, translation, pipeline);
        }
    ...
    public MultiblockAbility<IBall> getAbility() {
        return GSCapabilities.GRINDBALL;
    }
